        ...
        <div class="flex flex-column align-items-center justify-content-center">
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    ...
                    <div class="text-900 text-3xl font-medium mb-3">비밀번호를 잊으셨나요?</div>
                        ...
                        <div>
                            <div class="mb-5">
                                <InputGroup>
                                    ...
                                    <InputText id="userId1" v-model="userId" type="text" placeholder="아이디" :invalid="invalidHelp" :disabled="verifying" class="w-full" style="padding: 1rem" />
                                </InputGroup>
                                <InputGroup>
                                    <InputGroupAddon>
                                ...
                                <InputGroup>
                                    ...
                                    <InputText id="phoneNumber1" v-model="phoneNumber" type="text" placeholder="휴대전화번호" :invalid="invalidHelp" :disabled="verifying" class="w-full" style="padding: 1rem" />
                                </InputGroup>
                            ...
                            <Button v-if="!verifying" type="submit" label="코드 발송" class="w-full p-3 text-xl mb-5"></Button>
                            <Button v-if="verifying" type="button" label="다음" class="w-full p-3 text-xl mb-5" @click="handleHelpCode"></Button>
                        </div>
                    </form> 
                </div>
            </div>
