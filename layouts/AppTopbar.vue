        ...
        <div class="layout-topbar-menu" :class="topbarMenuClasses">
            ...
            <OverlayPanel class="card mb-0" ref="authOverlayOption" appendTo="body" :showCloseIcon="true" id="overlay_panel" style="width: 320px">
                <div class="text-700 text-center">
                    ...
                    <Button @click="onEditProfileClick()" label="프로필 수정" class="mr-3 font-bold px-2 py-3 p-button-raised p-button-rounded white-space-nowrap"></Button>
                    <Button @click="onSignOutClick()" label="로그아웃" severity="secondary" icon="pi pi-sign-out" class="px-2 py-3 p-button-raised p-button-rounded white-space-nowrap"></Button>
                </div>
            </OverlayPanel>
        </div>
    </div>
